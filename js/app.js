...
let c1 = createCanvas({width: $(window).width(),
height: $(window).height()});
let c2 = createCanvas({width: $(window).width(),
height: $(window).height()});
let c3 = createCanvas({width: $(window).width(),
height: $(window).height()});
...
writeText(c2.canvas, c2.context, 'Ada - UX Designer');
...
function writeText(canvas, context, text) {
  let size = 100;
  context.font = size + 'px Rancho';
  context.fillStyle = '#f7484e';
